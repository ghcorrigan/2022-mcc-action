...
%make sure the direction of activation is the same for seen and cancelled
glm_output.seen.sig_times(1,(glm_output.trial_type.beta_weights(1,:).* ...
    glm_output.seen.beta_weights(1,:)) <= 0) = 0;

%if conflict and seen isn't significant, we don't care about SSD being significant
