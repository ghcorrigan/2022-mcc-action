...
fileCheck = cell2mat(cellfun(@(x) contains(x,[region 'SDFDiff_workspaceA102dirPNCDirVal3knew.mat']),fileNames,'uni',0));
if any(fileCheck)
...
parfor neuron_i = 1:size(mcc_map_info,1)
    ...
    save(['E:\conflict\results\' region 'SDFDiff_workspaceA102dirPNCDirVal3knew.mat'])
